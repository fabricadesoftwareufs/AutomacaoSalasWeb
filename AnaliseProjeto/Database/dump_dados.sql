...
INSERT INTO `equipamento` (`id`, `modelo`,`marca`,`descricao`,`sala`,`hardwareDeSala`) VALUES 
				(1,"SAMSUNG","220TT","Condicionador SAMSUNG 110V classe de consumo E",1,NULL),
				(2,"ELGIN","SGV330","Condicionador ELGIN 110V classe de consumo G",2,NULL),
				(3,"LG","EXTENDER","Condicionador LG 110V classe de consumo G",3,NULL);

...
INSERT INTO `equipamento` (`marca`,`modelo`,`descricao`,`idSala`,`idHardwareDeSala`) VALUES
				('SAMSUNG','220TT','Condicionador SAMSUNG 110V classe de consumo E',1,17),
				('ELGIN','SGV330','Condicionador ELGIN 110V classe de consumo G',2,18),
				('LG','EXTENDER','Condicionador LG 110V classe de consumo G',3,19);

INSERT INTO `equipamento` (`marca`,`modelo`,`descricao`,`idSala`,`idHardwareDeSala`,tipoEquipamento) VALUES
                ('Fox', 'Luminum', 'Luz de LED de 15 watts',1,2,'LUZES');

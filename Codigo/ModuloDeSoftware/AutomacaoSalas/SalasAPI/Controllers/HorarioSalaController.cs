...
namespace SalasAPI.Controllers
{
    ...
    public class HorarioSalaController : ControllerBase
    {
        ...
        public ActionResult GetReservasUsuario(string diaSemana, uint idUsuario)
        {
            try
            {
        ...
        [AllowAnonymous]
        public ActionResult GetReservasDaSala(uint idSala)
        {
            try
            {
        ...
        [AllowAnonymous]
        public ActionResult GetReservasDaSamana(uint idSala)
        {
            try
            {
        ...
        [AllowAnonymous]
        public ActionResult GetReservasDeHoje(uint idSala)
        {
            try
            {

$(document).ready(function () {
    ...
    if (document.querySelector('.hardware-sala'))
        document.getElementById("btn-create-nova-sala").disabled = false;
    else
        document.getElementById("btn-create-nova-sala").disabled = true;
});
...
function adicionaHardwareNaTabela(indice, enderecoMac, tipoHardwareId, tipoHardwareTexto) {
    ...
    let hardware =
        ...
        '<input class="form-control" name="HardwaresSala[' + indice + '].SalaId.Id" value="0" hidden />' +
        '<input class="form-control" name="HardwaresSala[' + indice + '].SalaId.Titulo" value="nulo" hidden />' +
        '<input class="form-control" name="BlocoSala.Titulo" value="nulo" hidden />'+
